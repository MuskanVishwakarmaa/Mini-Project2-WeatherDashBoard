...
// Event listener for input box to suggest city names
inputBox.addEventListener('input', () => {
    const input = inputBox.value.trim();
    const suggestions = suggestCityNames(input);
...
async function checkWeather(city){
    ...
    // cordi.innerHTML = `${weather_body.coord.lat}`;
...
// Adding functionality to search on pressing Enter key
